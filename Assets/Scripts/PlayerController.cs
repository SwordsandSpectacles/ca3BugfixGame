...
public class PlayerController : MonoBehaviour {
    ...
    void FallHandler()
    { 
        // y > = minY was written, instead of <= 
        //The game was ending if y value was above instead of below minY 
    ...
    void WalkHandler()
    {
        ...
        //Was getting Vertical axis here instead of Horizontal
    ...
    void OnTriggerEnter(Collider other)
    {
        if(other.CompareTag("Coin"))
        {
            ...
            //There was no Destroy code here, added it in. 
